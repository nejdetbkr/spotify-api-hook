...
const scrollContainer = (id: string, { isNegative } = {} as INegative) => {
  return () => {
    const scrollableContainer = document.getElementById(id) as HTMLDivElement;
    ...
    return (
      <div className="discover-block">
        ...
        <div className="discover-block__row" id={id}>
          {data.map(({ [imagesKey]: images, name }: ISpotify) => (
